...
import {Direction, all, beginSlide, chain, createRef, slideTransition, waitUntil} from '@motion-canvas/core';
...
export default makeScene2D(function* (view) {
  ...
  view.add(
    <>
      <Grid
        ...
        />
        <Txt ref={title} opacity={1} position={[0, -425]} fontFamily={'Sci-Bi'} fill="#FFF" antialiased={false} fontSize={100}>Palette</Txt>
  ...
  yield* waitUntil("palette finished")
